<template>
  <v-footer class="mt-10 footer-container white" >
      <div class="pl-10"><router-link to="./"><v-img max-width="250" src="nilelogo.png"></v-img></router-link></div>
      <v-row align="center" class="mt-4" justify="center" >
        ...
        <v-row class="mt-5">
      <v-col cols="2" >
        <v-img width="25" src="facebook.png"></v-img>
      </v-col>
       <v-col cols="2">
        <v-img width="25" src="twitter.png"></v-img>
      </v-col>
       <v-col cols="2">
        <v-img width="25"  src="instagram.png"></v-img>
      </v-col>
       <v-col cols="2">
        <v-img width="25" src="linkedin.png"></v-img>
      </v-col>
    </v-row>
        </v-col>
